...
![](https://hackmd.io/_uploads/ryJERB-g6.png)

- **前序**：陣列的第一個元素是根節點。(**A**BDECFG)
- **中序**：根據根節點劃分了左右子樹的元素。(DBE**A**FCG)
- **後序**：陣列的最後一個元素是根節點。(DEBFGC**A**)
...
![](https://hackmd.io/_uploads/HyAkirbxp.png)
...
![](https://hackmd.io/_uploads/B1aaAH-gT.png)
